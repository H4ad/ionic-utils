 ...
 */
@Component({
  selector: 'app-test-http-async-one',
  template: `
    <div class="test">
      <h1>Testar requisição - Componente - 1</h1>
      ...
      <p>Está verificando se está online: Não</p>
      ...
      <hr>
      <button routerLink="/two">Ir para o dois</button>
    </div>
  `,
})
export class TestHttpAsyncOneComponent {
